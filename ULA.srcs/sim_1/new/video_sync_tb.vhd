...
begin
    ...
    begin
        ...
        loop
            ...
            if (vline >= 248 and vline <= 251) then
                expv := '1';
            else
                expv := '0';
            end if;
    ...
    dbg_exp_nborder <= '1' when dbg_vline <= 191 else
                       '0';
    dbg_exp_vsync   <= '1' when (dbg_vline >= 248 and dbg_vline <= 251) else
                       '0';
